...
from telemetry_backend.api.dependencies import ApiKeyDep, IngestionServiceDep
from telemetry_backend.api.dto import IngestPayloadDTO, ReadingDTO, ResponseEnvelope
from telemetry_backend.config.logging import get_logger
from telemetry_backend.services.ingestion_service import (
    AuthenticationError,
    DeviceInactiveError,
    DeviceNotFoundError,
    InvalidPayloadError,
