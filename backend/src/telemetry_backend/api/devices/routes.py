...
from telemetry_backend.api.dependencies import (
    AdminApiKeyDep,
    AggregationServiceDep,
    DeviceServiceDep,
)
from telemetry_backend.api.dto import (
    DeviceDTO,
...
from telemetry_backend.services.device_service import DeviceExistsError, DeviceNotFoundError
